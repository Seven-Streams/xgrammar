...
//       return Result<StructuralTag>::Err("Structural tag's type must be a string
//       \"structural_tag\""
//       );
//     }
//   }
...
//     return Result<SequenceFormat>::Err("Sequence format must have an elements field with an
//     array");
//   }
...
//   }
//   if (tags.size() == 0) {
//     return Result<TriggeredTagsFormat>::Err("Empty tags are not allowed in triggered tags
//     format");
//   }
...
//   }
//   return Result<int32_t>::Err(std::runtime_error("Wildcard text format has no detected end
//   string")
//   );
// }
