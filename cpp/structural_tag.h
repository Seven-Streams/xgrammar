...
struct ConstStringFormat {
  ...
  std::string ToString() const { return "{type: const_string, value: " + value + "}"; }
};
...
struct JSONSchemaFormat {
  ...
  std::string ToString() const { return "{type: json_schema, json_schema: " + json_schema + "}"; }
};
...
struct QwenXmlParameterFormat {
  ...
  std::string ToString() const { return "{type: qwen_xml, xml_schema: " + xml_schema + "}"; }
};
...
struct GrammarFormat {
  ...
  std::string ToString() const { return "{type: grammar, grammar: " + grammar + "}"; }
};
...
struct RegexFormat {
  ...
  std::string ToString() const { return "{type: regex, pattern: " + pattern + "}"; }
};

struct AnyTextFormat {
  static constexpr const char* type = "any_text";
  AnyTextFormat() {}
  std::string ToString() const { return "{type: any_text}"; }
