...
def test_repetition_range_min_max():
    ...
    before = """root ::= "a"{2,4}
"""
    expected = """root ::= (((root_1_xgrammar_repetition_context root_1_xgrammar_repetition_context_1 "a" "a")))
root_1_xgrammar_repetition_context ::= ("" | ("a")) (=(root_1_xgrammar_repetition_context_1 "a" "a"))
root_1_xgrammar_repetition_context_1 ::= ("" | ("a")) (=("a" "a"))
"""
    grammar = _ebnf_to_grammar_no_normalization(before)
    after = str(grammar)
    assert after == expected
...
def test_repetition_range_min_only():
    ...
    before = """root ::= "a"{2,}
"""
    expected = """root ::= (((root_1_xgrammar_repetition_context{2, 2147483643} root_1_xgrammar_repetition_context_1 root_1_xgrammar_repetition_context_2 root_1_xgrammar_repetition_context_3 root_1_xgrammar_repetition_context_4)))
...
rule1 ::= (((rule1_1_xgrammar_repetition_context rule1_1_xgrammar_repetition_context_1 [a-z]))) (=((":")))
rule2 ::= ((rule2_1 "." [0-9]*))
root_1 ::= ((((rule1) | (rule2)) root_1) | ((rule1) | (rule2)))
rule1_1_xgrammar_repetition_context ::= ("" | ([a-z])) (=(rule1_1_xgrammar_repetition_context_1 [a-z]))
rule1_1_xgrammar_repetition_context_1 ::= ("" | ([a-z])) (=([a-z]))
...
a ::= ((a_1_xgrammar_repetition_context "a"))
b ::= ((b_1_xgrammar_repetition_context{1, 1} b_1_xgrammar_repetition_context_1 b_1_xgrammar_repetition_context_2 b_1_xgrammar_repetition_context_3 b_1_xgrammar_repetition_context_4))
...
e ::= ((e_1_xgrammar_repetition_context{2, 2147483643} e_1_xgrammar_repetition_context_1 e_1_xgrammar_repetition_context_2 e_1_xgrammar_repetition_context_3 e_1_xgrammar_repetition_context_4))
f ::= (("fff"))
g ::= (())
